...
.Code Beispiel
----
include::{javaSourceDir}/de/renatius/tdd-playground/tipps/ExampleOneUnit.java[tags=contains,indent=0]
----

[source,java]
.Test Code Beispiel
----
include::{javaTestDir}/de/renatius/tdd-playground/tipps/ExampleOneUnitTest.java[tags=contains,indent=0]
----
