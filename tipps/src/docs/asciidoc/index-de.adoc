...
----
include::{javaSourceDir}/de/renatius/tdd/example/IntroExample.java[tags=contains,indent=0]
----

[source,java]
.Tests für das Beispiel
----
include::{javaTestDir}/de/renatius/tdd/example/IntroExampleTest.java[tags=contains,indent=0]
----
