...
----
include::{javaSourceDir}/de/renatius/tdd-playground/tipps/IntroExample.java[tags=contains,indent=0]
----

[source,java]
.Tests für das Beispiel
----
include::{javaTestDir}/de/renatius/tdd-playground/tipps/IntroExampleTest.java[tags=contains,indent=0]
----
